          ...
          <span className="loginbox">
            ...
            {this.state.isLoader ? <div className="lds-dual-ring"></div> :
              this.state.boxContent === "login" ?
                <form onSubmit={() => this.onSubmitHandler('login')}>
                  <div className="form-group">
                    <label className="box-label" htmlFor="inputlg">Mobile Number</label>
                    <input value={this.state.payload.mobileNumber} title="Enter 10 digit mobile number" id="mobileNumber" onChange={this.inputChangeHandler} className="form-control input-sm" type="tel" required />
                  </div>
                  <div className="form-group">
                    <label className="box-label" htmlFor="inputlg">Password</label>
                    <input value={this.state.payload.password} id="password" onChange={this.inputChangeHandler} className="form-control input-sm" type="password" required />
                  </div>
                  <div className="form-group">
                ...
                this.state.boxContent === "signUp" ?
                  <React.Fragment>
                    ...
                    <form id="signUp" onSubmit={this.onSignInSubmit}>
                      <div className="form-group">
                        <label className="box-label" htmlFor="inputlg">Name</label>
                        <input value={this.state.payload.name} id="name" onChange={this.inputChangeHandler} className="form-control input-sm" type="text" required />
                      </div>
                      <div className="form-group">
                        <label className="box-label" htmlFor="inputlg">Mobile Number</label>
                        <input value={this.state.payload.mobileNumber} pattern="[1-9]{1}[0-9]{9}" title="Enter 10 digit mobile number" id="mobileNumber" onChange={this.inputChangeHandler} className="form-control input-sm" type="tel" required />
                      </div>
                      <div className="form-group">
                        <label className="box-label" htmlFor="inputlg">Password</label>
                        <input value={this.state.payload.password} id="password" onChange={this.inputChangeHandler} className="form-control input-sm" type="password" required />
                  ...
                  <React.Fragment>
                    ...
                    {this.state.isSMSSentError && <p className="incorrect-password-text">Incorrect Mobile Number</p>}
                    <form className="mr-tb-45" id="resetPassword" onSubmit={this.onSubmitHandler}>
                      <div className="form-group">
                        <label className="box-label" htmlFor="inputlg">Mobile Number</label>
                        <input value={this.state.payload.mobileNumber} id="mobileNumber" onChange={this.inputChangeHandler} className="form-control input-sm" type="tel" required />
                      </div>
                      <div className="form-group">
