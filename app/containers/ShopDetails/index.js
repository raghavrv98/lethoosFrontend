                      ...
                      <React.Fragment>
                        ...
                        {this.state.orderHistory.orders.map((val, index) => {
                          ...
                          return <div key={index} className="order-details-items">
                            {val.isHalfSelected ?
                              <React.Fragment>{<span onClick={() => this.deleteMultipleItemHandler(index)} className="shop-details-minus-btn"><i className="fa fa-minus-square-o" aria-hidden="true"></i></span>}<span>{val.item} X <b>{val.halfQuantity}</b></span> <span className="float-right">{val.price * val.halfQuantity}</span><span>(Half)</span></React.Fragment>
                              :
                              <React.Fragment>{<span onClick={() => this.deleteMultipleItemHandler(index)} className="shop-details-minus-btn"><i className="fa fa-minus-square-o" aria-hidden="true"></i></span>}<span>{val.item} X <b>{val.quantity}</b></span> <span className="float-right">{val.price * val.quantity}</span></React.Fragment>
                            }
                          </div>
                        })}
                        <hr />
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-footer">
                  ...
                  <button type="button" className="btn btn-secondary confirm-modal-yes" onClick={this.orderReplacedHandler}>Yes</button>
                </div>
              </div>
            </div>
          </div>
