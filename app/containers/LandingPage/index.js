  ...
  render() {
    return (
      <div>
        ...
        <div className="offers-heading">{this.state.shopsCount} {this.state.shopsCount > 1 ? "Shops" : "Shop"} <hr /></div>
                  ...
                  this.state.shops.map((val, index) => {
                    if (val.isActive) {
                      return <div key={index} className="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                        <div onClick={() => this.props.history.push(`/shopDetails/${val._id}`)} className={val.status ? "box" : "box shop-closed-color"}>
